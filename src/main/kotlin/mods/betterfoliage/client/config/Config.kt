...
fun biomeList(defaults: (BiomeGenBase) -> Boolean) =
    intList {
...
private fun BiomeGenBase.filterClass(vararg name: String) =
    name.any { it in this.javaClass.name.lowercase() }
...
object Config : DelegatingConfig(BetterFoliageMod.MOD_ID, BetterFoliageMod.DOMAIN) {
  ...
  override fun onChange(event: ConfigChangedEvent.OnConfigChangedEvent) {
    ...
    else Minecraft.getMinecraft().renderGlobal.loadRenderers()
  }
}
