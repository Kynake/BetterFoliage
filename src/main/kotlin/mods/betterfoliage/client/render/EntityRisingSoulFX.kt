...
class EntityRisingSoulFX(world: World, x: Int, y: Int, z: Int) :
  ...
  override fun update() {
    ...
    velocity.setTo(
        cos[phase] * Config.risingSoul.perturb, 0.1, sin[phase] * Config.risingSoul.perturb)
  ...
  override fun render(tessellator: Tessellator, partialTickTime: Float) {
    ...
    renderParticleQuad(
        tessellator, partialTickTime, size = Config.risingSoul.headSize * 0.25, alpha = alpha)
