...
fun Model.columnSide(
  ...
  listOf(
          verticalRectangle(
                  x1 = 0.0, z1 = 0.5, x2 = 0.5 - radius, z2 = 0.5, yBottom = yBottom, yTop = yTop)
          ...
          verticalRectangle(
              ...
              .setAoShader(
                  faceOrientedAuto(
                      overrideFace = SOUTH,
                      corner =
                          cornerInterpolate(Axis.Y, chamferAffinity, Config.roundLogs.dimming)))
              .setAoShader(
                  faceOrientedAuto(
                      overrideFace = SOUTH,
  ...
  listOf(
          ...
          verticalRectangle(
                  x1 = 0.5, z1 = 0.5 - radius, x2 = 0.5, z2 = 0.0, yBottom = yBottom, yTop = yTop)
