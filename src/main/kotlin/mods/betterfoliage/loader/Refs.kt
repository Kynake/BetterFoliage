...
object Refs {
  ...
  val getUseNeighborBrightness =
      MethodRef(Block, "getUseNeighborBrightness", "func_149710_n", "n", ClassRef.boolean)
  val shouldSideBeRendered =
      MethodRef(
          Block,
  ...
  val mapRegisteredSprites =
      FieldRef(TextureMap, "mapRegisteredSprites", "field_110574_e", "bpr", Map)

  val IMetadataSerializer =
      ClassRef("net.minecraft.client.resources.data.IMetadataSerializer", "brw")
  ...
  val TextureAtlasSprite =
      ClassRef("net.minecraft.client.renderer.texture.TextureAtlasSprite", "bqd")
  ...
  val getUseNeighborBrightnessOverride =
      MethodRef(
          ...
          ClassRef.boolean,
          Block)
  val shouldRenderBlockSideOverride =
      MethodRef(
          BetterFoliageHooks,
