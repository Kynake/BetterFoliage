...
fun cornerInterpolate(edgeAxis: Axis, weight: Float, dimming: Float): CornerShaderFactory =
    { dir1, dir2, dir3 ->
...
class CornerTri(
  ...
  override fun rotate(rot: Rotation) =
      CornerTri(face.rotate(rot), dir1.rotate(rot), dir2.rotate(rot), func)
}
...
class EdgeInterpolateFallback(
  ...
  override fun rotate(rot: Rotation) =
      EdgeInterpolateFallback(face.rotate(rot), edgeDir.rotate(rot), pos)
}
